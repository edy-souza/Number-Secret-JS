...
function exibirMensagemInicial (){
    ...
    exibirTextoNaTela('p' , 'choose a number between one and hundred');
...
function verificarChute() {
    ...
    if (chute ==  numeroSecreto) {
        ...
        let palavraTentativa = attempts > 1 ? 'attempts' : 'tentativa';
...
// Gera um número INTEIRO aleatório de 1 a 20
